...
Hint 1: Do the easy thing first. Compress the string, then compare the lengths.
Hint 2: Be careful that you aren't repeatedly concatenating strings together. This can be very inefficient.
'''
import time
import unittest
